...
const ProductDetails = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoading(true);
      try {
        const response = await fetch("/product-catelog/products.json"); // Fetch your JSON file
    ...
    <div>
      ...
      <div className="button-container"> 
        ...
        <button onClick={handleAddToWishlist} className="WishlistBtn">
          <span className="IconContainer"> 
            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" fill="rgb(17, 17, 17)">
